...
(custom-theme-set-faces
 ...
 '(mode-line-inactive ((t (:background "gray30" :foreground "gray80" :weight light))))
 '(powerline-active1 ((t (:background "grey22" :foreground "PaleTurquoise2"))))
 '(powerline-active2 ((t (:background "grey40" :foreground "PaleTurquoise1"))))
